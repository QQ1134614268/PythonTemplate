!function (e, t) {
    ...
    var w = v(function (z) {
        ...
        var t, m, R, M, N, O, s, G = Object.assign({}, _), H = "./this.program", V = "object" == typeof window,
            ...
            e = "", j = ($ ? (e = h ? Ut.default.dirname(e) + "/" : __dirname + "/", O = () => {
        ...
        function ue(e) {
            this.excPtr = e, this.ptr = e - 24, this.set_type = function (e) {
                ...
                if (St(this.get_type())) return p[this.excPtr >> 2];
        ...
        var n = {
            ttys: [], init: function () {
                ...
                n.ttys[e] = {input: [], output: [], ops: t}, E.registerDevice(e, n.stream_ops)
            }, stream_ops: {
                open: function (e) {
        ...
        var S = {
            ops_table: null, mount: function (e) {
                ...
                read: function (e, t, r, i, n) {
                    ...
                    if (2 & n || e.buffer !== q) {
                        if ((0 < r || r + t < e.length) && (e = e.subarray ? e.subarray(r, r + t) : Array.prototype.slice.call(e, r, r + t)), a = !0, !(s = ce(t))) throw new E.ErrnoError(48);
                        f.set(e, s)
            ...
            createDefaultDevices: () => {
                E.mkdir("/dev"), E.registerDevice(E.makedev(1, 3), {
                    read: () => 0,
                    write: (e, t, r, i, n) => i
                }), E.mkdev("/dev/null", E.makedev(1, 3)), n.register(E.makedev(5, 0), n.default_tty_ops), n.register(E.makedev(6, 0), n.default_tty1_ops), E.mkdev("/dev/tty", E.makedev(5, 0)), E.mkdev("/dev/tty1", E.makedev(6, 0));
                var e = function () {
                    var e;
                ...
                if (n.prototype.get = function (e) {
                    ...
                    s.setDataGetter(e => {
                        ...
                        if (void 0 === s.chunks[e] && (s.chunks[e] = ((e, t) => {
                            ...
                            if (r.open("GET", a, !1), i !== n && r.setRequestHeader("Range", "bytes=" + e + "-" + t), r.responseType = "arraybuffer", r.overrideMimeType && r.overrideMimeType("text/plain; charset=x-user-defined"), r.send(null), 200 <= r.status && r.status < 300 || 304 === r.status) return void 0 !== r.response ? new Uint8Array(r.response || []) : pe(r.responseText || "", !0);
            ...
            createPreloadedFile: (r, i, e, n, s, a, o, l, d, h) => {
                ...
                function c(e) {
                    function t(e) {
                        h && h(), l || E.createDataFile(r, i, e, n, s, d), a && a(), oe()
                    }
                ...
                ae(), "string" == typeof e ? (f = o, u = "al " + (t = e), m(t, e => {
                    Y(e, 'Loading data file "' + t + '" failed (no arrayBuffer).'), c(new Uint8Array(e)), u && oe()
                }, e => {
        ...
        function Ee(i, t, n) {
            function r(e) {
                var t = n(e);
                t.length !== i.length && Se("Mismatched type converter count");
        ...
        function Ie(e, t) {
            return t.ptrType && t.ptr || Se("makeClassHandle requires ptr and ptrType"), !!t.smartPtrType != !!t.smartPtr && Se("Both smartPtrType and smartPtr must be specified"), t.count = {value: 1}, Pe(Object.create(e, {$$: {value: t}}))
        }

        function Pe(e) {
            return "undefined" == typeof FinalizationRegistry ? (Pe = e => e, e) : (xe = new FinalizationRegistry(e => {
                Ae(e.$$)
            }), Be = e => xe.unregister(e), (Pe = e => {
                var t = e.$$;
        ...
        function D(e, t, r, i, n, s, a, o, l, d, h) {
            this.name = e, this.registeredClass = t, this.isReference = r, this.isConst = i, this.isSmartPointer = n, this.pointeeType = s, this.sharingPolicy = a, this.rawGetPointee = o, this.rawConstructor = l, this.rawShare = d, this.rawDestructor = h, n || void 0 !== t.baseClass ? this.toWireType = Ne : (this.toWireType = i ? Me : Oe, this.destructorFunction = null)
        }
        ...
        function I(e, t) {
            var n, s, a, r = (e = x(e)).includes("j") ? (n = e, s = t, a = [], function () {
                return a.length = 0, Object.assign(a, arguments), t = s, r = a, (e = n).includes("j") ? (i = t, e = _["dynCall_" + e], r && r.length ? e.apply(null, [i].concat(r)) : e.call(null, i)) : Ve(t).apply(null, r);
                var e, t, r, i
            }) : Ve(t);
        ...
        var Qe = {
            toValue: e => (e || k("Cannot use deleted val. handle = " + e), P[e].value), toHandle: e => {
                switch (e) {
                    case void 0:
                        return 1;
                    case null:
        ...
        }), E.FSNode = pt, E.staticInit();
        for (var ct = new Array(256), mt = 0; mt < 256; ++mt) ct[mt] = String.fromCharCode(mt);
        _e = ct, T = _.BindingError = ve(Error, "BindingError"), we = _.InternalError = ve(Error, "InternalError"), F.prototype.isAliasOf = function (e) {
            ...
            var e, t = [];
            for (e in De) De.hasOwnProperty(e) && t.push(De[e]);
            return t
        ...
        }, D.prototype.argPackAdvance = 8, D.prototype.readValueFromPointer = Ge, D.prototype.deleteObject = function (e) {
            null !== e && e.delete()
            ...
            if (i = function (e, t) {
                ...
                return t
            }(i = this.registeredClass, i = t), void 0 !== (i = De[i])) {
            ...
            function r() {
                return this.isSmartPointer ? Ie(this.registeredClass.instancePrototype, {
                    ...
                    smartPtrType: this,
                    smartPtr: e
                }) : Ie(this.registeredClass.instancePrototype, {ptrType: this, ptr: e})
            }
            ...
            return null === n ? r.call(this) : this.isSmartPointer ? Ie(i.registeredClass.instancePrototype, {
                ptrType: i,
                ptr: n,
                smartPtrType: this,
                smartPtr: e
            }) : Ie(i.registeredClass.instancePrototype, {ptrType: i, ptr: n})
        }, $e = _.UnboundTypeError = ve(Error, "UnboundTypeError"), _.count_emval_handles = function () {
        ...
        var _t = {
            s: function (e) {
                ...
                }, _.hasOwnProperty(r) ? (k("Cannot register public name '" + r + "' twice"), Le(_, r, r), _.hasOwnProperty(a) && k("Cannot register multiple overloads of a function with the same number of arguments (" + a + ")!"), _[r].overloadTable[a] = i) : _[r] = i, Ee([l, e, t], d ? [d] : [], function (e) {
                    e = e[0], e = d ? (a = e.registeredClass).instancePrototype : F.prototype;
                    var t, r, i = be(m, function () {
                        ...
                        s = (i.prototype = n, new ze(p, i, n, c, a, h, f, u)), e = new D(p, s, !0, !1, !1),
                        a = new D(p + "*", s, !1, !1, !1), o = new D(p + " const*", s, !1, !0, !1);
                    return Te[l] = {
                        pointerType: a,
                        constPointerType: o
                    }, t = m, i = i, _.hasOwnProperty(t) || Se("Replacing nonexistant public symbol"), _[t].overloadTable, _[t] = i, _[t].argCount = r, [e, a, o]
                })
            }, k: function (e, i, t, r, n, s) {
                Y(0 < i);
                var a = Ye(i, t);
                n = I(r, n), Ee([], [e], function (t) {
                ...
                s = x(s), o = I(r, o), Ee([], [e], function (t) {
                    ...
                    return void 0 === n || void 0 === n.overloadTable && n.className !== t.name && n.argCount === a - 2 ? (e.argCount = a - 2, e.className = t.name, i[s] = e) : (Le(i, s, r), i[s].overloadTable[a - 2] = e), Ee([], h, function (e) {
                        e = Xe(r, e, t, o, l);
                ...
                var r = function (e, t) {
                    for (var r, i, n = new Array(e), s = 0; s < e; ++s) n[s] = (r = p[t + 4 * s >> 2], void 0 === (i = A[r]) && k("parameter " + s + " has unknown type " + je(r)), i);
                    return n
                ...
                var t = Ke(Function, s).apply(null, a), f = dt.length;
                return dt.push(t), ht[i] = n = f
            }, a: function () {
                b("")
            }, A: function (e, t, r) {
            ...
            function r(e, t) {
                var e = e.exports;
                _.asm = e, e = _.asm.F.buffer, q = e, _.HEAP8 = f = new Int8Array(e), _.HEAP16 = l = new Int16Array(e), _.HEAP32 = d = new Int32Array(e), _.HEAPU8 = u = new Uint8Array(e), _.HEAPU16 = K = new Uint16Array(e), _.HEAPU32 = p = new Uint32Array(e), _.HEAPF32 = X = new Float32Array(e), _.HEAPF64 = Z = new Float64Array(e), J = _.asm.J, e = _.asm.G, ne.unshift(e), oe()
            }
            ...
            function n(e) {
                return function () {
                    if (!s && (V || h)) {
                        if ("function" == typeof fetch && !de(c)) return fetch(c, {credentials: "same-origin"}).then(function (e) {
            ...
            if (ae(), _.instantiateWasm) try {
                return _.instantiateWasm(t, r)
            } catch (t) {
                return o("Module.instantiateWasm callback failed with error: " + t)
            }
            s || "function" != typeof WebAssembly.instantiateStreaming || le(c) || de(c) || $ || "function" != typeof fetch ? n(i) : fetch(c, {credentials: "same-origin"}).then(function (e) {
        ...
        }, bt = _.___getTypeName = function () {
            return (bt = _.___getTypeName = _.asm.L).apply(null, arguments)
        };
        ...
        var vt, wt = _._emscripten_builtin_memalign = function () {
            return (wt = _._emscripten_builtin_memalign = _.asm.N).apply(null, arguments)
        }, St = _.___cxa_is_pointer_type = function () {
            return (St = _.___cxa_is_pointer_type = _.asm.O).apply(null, arguments)
        };

        function Et() {
            function e() {
                if (!vt && (vt = !0, _.calledRun = !0, !W)) {
                    if (_.noFSInit || E.init.initialized || E.init(), E.ignorePermissions = !1, fe(ne), _.onRuntimeInitialized && _.onRuntimeInitialized(), _.postRun) for ("function" == typeof _.postRun && (_.postRun = [_.postRun]); _.postRun.length;) e = _.postRun.shift(), se.unshift(e);
                    var e;
                    fe(se)
                }
            }
