...
import { POST_LEVEL_CRATE_API, POST_LEVEL_PAGE_API, POST_LEVEL_UPDATE_API, POST_LEVEL_DELETE_API, POST_LEVEL_DELETE_BATCH_API } from "@/api/api";
...
export default {
    ...
    methods: {
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    if (this.form.id == null) {
                        postJson2(POST_LEVEL_CRATE_API, this.form);
                        this.$message.success("修改成功");
                    } else {
                        postJson2(POST_LEVEL_UPDATE_API, this.form);
                        this.$message.success("修改成功");
                    }
        ...
        // 批量删除或者单个删除
        handleDelete(row) {
            postJson2(POST_LEVEL_DELETE_API, row.id);
        },
    }
};
</script>