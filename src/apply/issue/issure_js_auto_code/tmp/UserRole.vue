...
import { USER_ROLE_CRATE_API, USER_ROLE_PAGE_API, USER_ROLE_UPDATE_API, USER_ROLE_DELETE_API, USER_ROLE_DELETE_BATCH_API } from "@/api/api";
...
export default {
    ...
    methods: {
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    if (this.form.id == null) {
                        postJson2(USER_ROLE_CRATE_API, this.form);
                        this.$message.success("修改成功");
                    } else {
                        postJson2(USER_ROLE_UPDATE_API, this.form);
                        this.$message.success("修改成功");
                    }
        ...
        // 批量删除或者单个删除
        handleDelete(row) {
            postJson2(USER_ROLE_DELETE_API, row.id);
        },
    }
};
</script>